...
const Treatment = loadable(() =>
  import("Pages/FemaleInfertility/diagtreat/treatment")
);
const SectionHeading = loadable(() => import("Components/section-heading"));
const TabButton = loadable(() => import("Components/tabs/tab-button"));
const Diagnosis = loadable(() =>
  import("Pages/FemaleInfertility/diagtreat/diagnosis")
);
